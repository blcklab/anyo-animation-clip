import { eulerXYZFromQuaternion, normalizeQuaternion, quaternionFromEulerXYZ } from './quaternion.js';
export function composeMatrix4(position, rotation, scale) {
...
export function matrixFromTransform(transform) {
    return composeMatrix4(transform.position, transform.quaternion ?? quaternionFromEulerXYZ(transform.rotation), transform.scale);
}
...
export function decomposeMatrix4(matrix, shearTolerance = 1e-5) {
...
export function relativeTransformMatrix(parentWorld, world) {
