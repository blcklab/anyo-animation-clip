...
export function getWallFrame(room, elevation, wall) {
...
export function wallSegmentSize(frame, length, height) {
    return frame.tangentAxis === 'x'
        ? [length, height, frame.thickness]
        : [frame.thickness, height, length];
}
export function pointOnWall(frame, tangent, vertical, depth = 0) {
