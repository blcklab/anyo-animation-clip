...
exports.AnyoValidationError = void 0;
class AnyoValidationError extends Error {
    issues;
    details;
    constructor(issues) {
        const details = issues.map((issue) => typeof issue === 'string'
...
exports.AnyoValidationError = AnyoValidationError;
