...
function arrayIdentityChanged(before, after) {
...
function pushReplace(path, before, after, forward, inverse) {
...
function diffValue(before, after, path, forward, inverse) {
...
function createHistoryEntry(label, before, after) {
    const forward = [];
    const inverse = [];
...
class DocumentHistory {
    ...
    pushPatches(label, forward, inverse) {
        if (forward.length === 0)
            return null;
