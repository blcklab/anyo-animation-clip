...
exports.Sekai64CameraAdapter = void 0;
const sekai64_1 = require("@blcklab/sekai64");
class Sekai64CameraAdapter {
    resolveNativeCamera;
    applyProjection;
    canvas;
    constructor(resolveNativeCamera, applyProjection, canvas) {
        this.resolveNativeCamera = resolveNativeCamera;
        this.applyProjection = applyProjection;
        this.canvas = canvas;
    }
    get nativeCamera() { return this.resolveNativeCamera(); }
    getPosition() {
    ...
    getProjection() {
        ...
        if (camera instanceof sekai64_1.OrthographicCamera) {
            return {
                type: 'orthographic',
        ...
        if (camera instanceof sekai64_1.PerspectiveCamera) {
            return {
                type: 'perspective',
...
exports.Sekai64CameraAdapter = Sekai64CameraAdapter;
//# sourceMappingURL=Sekai64CameraAdapter.js.map