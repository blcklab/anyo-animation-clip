export const ANYO_ANIMATION_TRACK_SOURCE = 'anyo:animation:property-tracks';
export const ANYO_ANIMATION_TRACK_PRIORITY = 10;
const AXIS_INDEX = Object.freeze({ x: 0, y: 1, z: 2 });
export function hasPropertyTracks(config) {
    return (config.tracks?.length ?? 0) > 0;
}
export function requiresAnimationBinding(config) {
...
export function evaluatePropertyTracks(tracks, timeSeconds, entity) {
    if (tracks.length === 0)
        return null;
...
export function evaluatePropertyTrack(track, timeSeconds) {
