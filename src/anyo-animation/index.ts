...
export interface ExternalClipRegistrar {
  registerExternalClips(model:GltfModelNode, clips:readonly AnimationClip[], options?:{readonly restorePose?:()=>void}):()=>void
}
/** Additive bridge for @blcklab/anyo-animation's Sekai64 adapter. No mixer ownership is duplicated here. */
export function registerPreparedClips(registrar:ExternalClipRegistrar, prepared:PreparedSekai64ClipSet):()=>void {
